...
export function SuggestLinkForm({ bookNodes, onAddLink, authorsMap }: Props) {
  ...
  if (!show) {
    return (
      <Button
        ...
        className="w-full cursor-pointer rounded-lg border border-white/15 bg-white/5 py-2.5 text-label font-bold uppercase tracking-[1.5px] text-white/70 transition-all hover:bg-white/10 hover:text-white"
      >
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-lg border border-white/10 bg-white/5 p-3">
      <h4 className="mb-3 text-caption font-bold uppercase tracking-[1.5px] text-white/70">
        Nouveau lien suggéré
      </h4>

      <label className="mb-1 block text-micro uppercase text-white/30">Source</label>
      <TextInput
        variant="table"
      ...
      <label className="mb-1 block text-micro uppercase text-white/30">Cible</label>
      <TextInput
        variant="table"
        className="mb-2 rounded border border-white/10 bg-white/5 px-2 py-1.5 text-[0.8rem] placeholder:text-white/35"
      ...
      <div className="flex gap-2">
        <Button
          ...
          className="flex-1 cursor-pointer rounded border border-white/15 bg-white/5 py-1.5 text-caption font-bold uppercase text-white/70 transition-all hover:bg-white/10 hover:text-white disabled:cursor-not-allowed disabled:opacity-30"
        >
          Proposer
        </Button>
        <Button
          ...
          className="cursor-pointer rounded border border-white/10 bg-white/5 px-3 py-1.5 text-caption text-white/40 transition-all hover:text-white/70"
        >
          Annuler
        </Button>
      </div>
