...
export function AddBookForm({
  ...
  const inputClass =
    'w-full rounded-[10px] border border-border-default bg-white/5 px-4 py-3 text-[0.95rem] text-white outline-none transition-all placeholder:text-text-secondary focus:border-cyan/40 focus:bg-white/10 focus:shadow-[0_0_0_3px_rgba(140,220,255,0.06)]'
