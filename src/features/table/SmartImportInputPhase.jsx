...
export default function SmartImportInputPhase({
  ...
  return (
    <>
      ...
      <textarea
        className="mb-4 h-36 w-full resize-none rounded-xl border border-white/10 bg-white/4 p-3 font-mono text-[0.75rem] text-white outline-none placeholder:text-white/18 transition-all focus:border-[rgba(140,220,255,0.28)] focus:bg-white/6"
        placeholder={
