import { ArrowRight, Check, Eye, Link2, Search, Trash2 } from 'lucide-react'
                          ...
                          <button
                            ...
                            className={[
                              ...
                              isDeleting
                                ...
                                : 'border-transparent text-white/18 opacity-0 group-hover:opacity-100 hover:border-[rgba(140,220,255,0.35)] hover:text-[rgba(140,220,255,0.8)]',
                            ].join(' ')}
