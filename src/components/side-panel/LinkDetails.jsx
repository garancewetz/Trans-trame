export default function LinkDetails({ selectedLink, getLinkNodes }) {
  ...
  return (
    <div className="px-6 pb-8 pt-12">
      <span className="mb-3 inline-block rounded-full bg-linear-to-br from-[rgba(140,220,255,0.8)] to-[rgba(80,160,255,0.9)] px-3 py-[3px] text-[0.72rem] font-bold uppercase tracking-[0.5px] text-white">
        Lien
      </span>
      <h2 className="mb-1 text-[1.1rem] font-bold leading-snug text-white">
        {source?.title} &rarr; {target?.title}
      </h2>
      <p className="mb-5 text-[0.85rem] text-white/45">
        {source?.author} &mdash; {target?.author}
      </p>
